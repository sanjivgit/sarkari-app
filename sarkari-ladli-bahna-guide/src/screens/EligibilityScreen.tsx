...
const NOT_ELIGIBLE = [
  'Income tax payers and their families',
  'Government employees and pensioners in the family',
  'Women receiving ₹1,250+ per month from other govt schemes',
  'Families owning a four-wheeler (except tractor)',
  'Unmarried women',
  'Non-residents of Madhya Pradesh',
];
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.tipBox}>
          ...
          <Text style={styles.tipText}>
            Not sure if you're eligible? Visit your nearest Ladli Behna camp,
            Gram Panchayat, or Ward office. They will help you check your
