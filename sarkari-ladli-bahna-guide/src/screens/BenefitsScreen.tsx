...
const PAYMENT_SCHEDULE = [
  { label: 'Monthly Payment', month: 'Every Month', amount: '₹1,500', icon: '💰' },
  { label: 'Annual Total', month: '12 Months', amount: '₹18,000', icon: '📅' },
  { label: 'Transfer Mode', month: 'Direct DBT', amount: 'Bank A/c', icon: '🏦' },
];
    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.hero}>
          ...
          <Text style={styles.heroAmount}>₹1,500</Text>
          <Text style={styles.heroLabel}>Per Month • Direct Bank Transfer</Text>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>How Women Use This Assistance</Text>
          <View style={styles.usageGrid}>
            {[
              { emoji: '🏠', label: 'Household', pct: '35%' },
              { emoji: '👧', label: 'Children', pct: '25%' },
              { emoji: '💊', label: 'Healthcare', pct: '20%' },
              { emoji: '📚', label: 'Education', pct: '20%' },
            ].map((u, i) => (
        ...
        <View style={styles.noteBox}>
          ...
          <Text style={styles.noteText}>
            Samagra ID is mandatory for application. Benefits are credited to
            your own Aadhaar-linked DBT bank account — no middlemen involved.
          </Text>
        </View>
