    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          {[
            'Get Samagra Family ID and Member ID before visiting the camp.',
            'Ensure your Aadhaar is linked to your bank account with DBT enabled.',
            'Bank account must be in your own name only — joint accounts are not accepted.',
            'Carry original Aadhaar and bank passbook for verification at the camp.',
          ].map((tip, i) => (
        ...
        <View style={styles.warningBox}>
          ...
          <Text style={styles.warningText}>
            ...
            completely FREE at Gram Panchayat, Ward office, or Ladli Behna camps.
            Check status at cmladlibahna.mp.gov.in.
          </Text>
        </View>
